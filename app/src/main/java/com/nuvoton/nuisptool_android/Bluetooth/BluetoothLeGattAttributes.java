...
public class BluetoothLeGattAttributes {
    ...
    public static String MY_DEVICE_MAC = "B8:27:EB:3F:D6:49";

    public static String CHANGEON_CONNECT_INFO = "00001111-0000-1000-8000-008000000000";
    public static String CHANGEON_PASSWORD_CHANGE= "00002222-0000-1000-8000-008000000000";

    public static String CHANGEON_WIFI_SSID_PASSWORD = "2221";
